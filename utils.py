...
def format_sample_data(column_names, data_records):
    ...
    for col_name in column_names:
        ...
        values = set(record[column_names.index(col_name)] for record in data_records if
                     record[column_names.index(col_name)] is not None and record[column_names.index(col_name)] != '')
